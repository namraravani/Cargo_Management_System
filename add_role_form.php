        ...
        <div class="container">
            <form action="add_role.php" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="role_id" id="role_id" placeholder="Enter Role ID">
                </div>
                <div class="form-group">
                    <label for="role_title">Title</label>
                    <input type="text" class="form-control" name="role_title" id="role_title" placeholder="Enter Role Title">
                </div>
                <div class="form-group">
