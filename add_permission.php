...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $sql = "insert into permisson(cargo_id,cargo_sales,cargo_type,cargo_description,cargo_customer_id,cargo_order) values(:cargo_id,:cargo_sales,:cargo_type,:cargo_description,:cargo_customer_id,:cargo_order)";
